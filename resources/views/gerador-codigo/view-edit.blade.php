...
<div class="card">
  <h3 class="card-header">
    ...
    <div class="btn-group " role="group" aria-label="Controles">
        <a class="btn btn-secondary btn-sm" id="btn-salvar-view-edit"><i class="fa fa-save"></i></a> 
    </div>
  </h3>
...
$(document).ready(function () {
    ...
    $('#btn-salvar-view-edit').click(function () {

    // Pergunta
    swal({
      title: 'Tem certeza que deseja salvar o arquivo de View Edit gerado?',
      type: "warning",
    ...
    function(isConfirm) {
        ...
        if (isConfirm) {
            ...
            $.ajax({
                ...
                url: '{{ url("gerador-codigo/$tabela/view/edit") }}',
                data: {
                    tabela: '{{ $tabela }}',
                    model: '{{ $model }}',
                    titulo: '{{ $titulo }}',
