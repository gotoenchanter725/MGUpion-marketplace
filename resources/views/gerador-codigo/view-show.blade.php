...
<div class="card">
  <h3 class="card-header">
    ...
    <div class="btn-group " role="group" aria-label="Controles">
        <a class="btn btn-secondary btn-sm" id="btn-salvar-view-show"><i class="fa fa-save"></i></a> 
    </div>
  </h3>
...
$(document).ready(function () {
    ...
    $('#btn-salvar-view-show').click(function () {

    // Pergunta
    swal({
      title: 'Tem certeza que deseja salvar o arquivo de View Show gerado?',
      type: "warning",
    ...
    function(isConfirm) {
        ...
        if (isConfirm) {
            ...
            $.ajax({
                ...
                url: '{{ url("gerador-codigo/$tabela/view/show") }}',
                data: {
                    tabela: '{{ $tabela }}',
                    model: '{{ $model }}',
                    titulo: '{{ $titulo }}',
